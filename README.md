...
FrostMI 当前界面围绕 Mac 本机 AI Agent 的端上感知展开。主界面以 **Agent Sensing** 为核心入口，展示本机 Agent、MCP Server、Skills、Context、Memory 和权限状态，并支持重新构建画像、分页查看、点击定位文件路径、导出 JSONL 以及在 Finder 中打开相关资产。
